...
ifeq (,$(wildcard nodelogs))
	...
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(PRIME_COINBASE) --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(PRIME_PORT_TCP) --http.port $(PRIME_PORT_HTTP) --ws.port $(PRIME_PORT_WS) --dom.url $(PRIME_DOM_URL):$(PRIME_PORT_WS) --quaistats ${STATS_NAME}:prime${STATS_PASS}@${PRIME_STATS_HOST} >> nodelogs/prime.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_1_PORT_TCP) --http.port $(REGION_1_PORT_HTTP) --ws.port $(REGION_1_PORT_WS) --dom.url $(REGION_1_DOM_URL):$(REGION_1_PORT_WS) --region 1 --quaistats ${STATS_NAME}:region1${STATS_PASS}@${REGION_1_STATS_HOST} >> nodelogs/region-1.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_2_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_2_PORT_TCP) --http.port $(REGION_2_PORT_HTTP) --ws.port $(REGION_2_PORT_WS) --dom.url $(REGION_2_DOM_URL):$(REGION_2_PORT_WS) --region 2 --quaistats ${STATS_NAME}:region2${STATS_PASS}@${REGION_2_STATS_HOST} >> nodelogs/region-2.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_3_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_3_PORT_TCP) --http.port $(REGION_3_PORT_HTTP) --ws.port $(REGION_3_PORT_WS) --dom.url $(REGION_3_DOM_URL):$(REGION_3_PORT_WS) --region 3 --quaistats ${STATS_NAME}:region3${STATS_PASS}@${REGION_3_STATS_HOST} >> nodelogs/region-3.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_1_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_1_1_PORT_TCP) --http.port $(ZONE_1_1_PORT_HTTP) --ws.port $(ZONE_1_1_PORT_WS) --dom.url $(ZONE_1_1_DOM_URL):$(ZONE_1_1_PORT_WS) --region 1 --zone 1 --quaistats ${STATS_NAME}:zone11${STATS_PASS}@${ZONE_1_1_STATS_HOST} >> nodelogs/zone-1-1.log 2>&1 &
