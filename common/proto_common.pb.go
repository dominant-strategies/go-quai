...
func (x *ProtoBigInt) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoBigInt) ProtoMessage() {}

func (x *ProtoBigInt) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_common_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtoBigInt.ProtoReflect.Descriptor instead.
func (*ProtoBigInt) Descriptor() ([]byte, []int) {
	return file_common_proto_common_proto_rawDescGZIP(), []int{6}
}

func (x *ProtoBigInt) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_common_proto_common_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x23, 0x0a, 0x0b, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x42, 0x69, 0x67, 0x49, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x2f,
	...
	0x2f, 0x67, 0x6f, 0x2d, 0x71, 0x75, 0x61, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62,
...
var file_common_proto_common_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_common_proto_common_proto_goTypes = []interface{}{
	...
	(*ProtoBigInt)(nil),    // 6: common.ProtoBigInt
}
