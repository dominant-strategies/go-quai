...
func (progpow *Progpow) CalcPrimeDifficulty(chain consensus.ChainHeaderReader, parent *types.Header) (*big.Int, error) {
	nodeCtx := common.NodeLocation.Context()
...
func (progpow *Progpow) CalcRegionDifficulty(chain consensus.ChainHeaderReader, parent *types.Header) (*big.Int, error) {
	nodeCtx := common.NodeLocation.Context()
