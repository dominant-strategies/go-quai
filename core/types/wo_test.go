...
var (
	expectedWoHash         = common.HexToHash("0x1c851ae2e5447a00c7359d1de0850c4aeb1a07744d856c1d2b844bc946e818a7")
	expectedUncleHash      = common.HexToHash("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347")
	expectedPETXProtoBytes = []byte{0xa, 0xc6, 0x1, 0xa, 0x22, 0xa, 0x20, 0xfb,
		0x31, 0x9c, 0x17, 0x22, 0xa, 0xa6, 0x31, 0x35, 0xa, 0x49, 0x8a, 0xa9, 0x49,
		0x5a, 0x10, 0xd9, 0x3, 0x93, 0x19, 0x6a, 0xfe, 0x7c, 0x8e, 0xe5, 0xea, 0x46,
		0x81, 0x4f, 0xd6, 0x20, 0x29, 0x12, 0x22, 0xa, 0x20, 0xfb, 0x31, 0x9c, 0x17,
		0x22, 0xa, 0xa6, 0x31, 0x35, 0xa, 0x49, 0x8a, 0xa9, 0x49, 0x5a, 0x10, 0xd9,
		0x3, 0x93, 0x19, 0x6a, 0xfe, 0x7c, 0x8e, 0xe5, 0xea, 0x46, 0x81, 0x4f, 0xd6,
		0x20, 0x29, 0x1a, 0x1, 0x1, 0x22, 0x4, 0x7, 0x5b, 0xcd, 0x15, 0x2a, 0x22,
		0xa, 0x20, 0x0, 0x4, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0, 0x12, 0x34, 0x56,
		0x78, 0x9a, 0xbc, 0xde, 0xf0, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde,
		0xf0, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf3, 0x30, 0x1, 0x3a, 0x4,
		0xa, 0x2, 0x0, 0x0, 0x42, 0x22, 0xa, 0x20, 0x0, 0x0, 0x56, 0x78, 0x9a, 0xbc,
		0xde, 0xf0, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0, 0x12, 0x34,
		0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc,
		0xde, 0xf4, 0x48, 0x1, 0x52, 0x1, 0x2a, 0x58, 0x0, 0x62, 0x16, 0xa, 0x14,
		0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x1, 0x23, 0x45, 0x67, 0x89, 0xab,
		0xcd, 0xef, 0x1, 0x23, 0x45, 0x67, 0x89, 0x6a, 0x4, 0x0, 0x1, 0x2, 0x3,
		0x12, 0x8c, 0x5, 0xa, 0x89, 0x5, 0xa, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f,
		...
		0xe3, 0x63, 0xb4, 0x21, 0xa, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b,
		...
		0xb4, 0x21, 0x12, 0x22, 0xa, 0x20, 0x1d, 0xcc, 0x4d, 0xe8, 0xde, 0xc7, 0x5d,
		0x7a, 0xab, 0x85, 0xb5, 0x67, 0xb6, 0xcc, 0xd4, 0x1a, 0xd3, 0x12, 0x45,
		0x1b, 0x94, 0x8a, 0x74, 0x13, 0xf0, 0xa1, 0x42, 0xfd, 0x40, 0xd4, 0x93,
		0x47, 0x1a, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6,
		0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0, 0x1b,
		0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0x22,
		0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6, 0xff, 0x83,
		0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c,
		0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0x2a, 0x22, 0xa,
		0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6, 0xff, 0x83, 0x45,
		0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad,
		0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0x32, 0x22, 0xa, 0x20,
		...
		0xb5, 0xe3, 0x63, 0xb4, 0x21, 0x3a, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17,
		0x1b, 0xcc, 0x55, 0xa6, 0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e,
		0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3,
		0x63, 0xb4, 0x21, 0x3a, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc,
		...
		0x21, 0x42, 0x22, 0xa, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x52, 0x0, 0x52, 0x0, 0x52, 0x0,
		0x5a, 0x0, 0x5a, 0x0, 0x5a, 0x0, 0x62, 0x0, 0x62, 0x0, 0x62, 0x0, 0x6a, 0x0,
		0x72, 0x0, 0x72, 0x0, 0x78, 0x0, 0x80, 0x1, 0x0, 0x8a, 0x1, 0x0, 0x9a, 0x1,
		0x0, 0xb2, 0x1, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55,
		...
		0xba, 0x1, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6,
		0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0, 0x1b,
		0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0xc0,
		0x1, 0x0, 0xc8, 0x1, 0x0, 0xd0, 0x1, 0x0, 0xda, 0x1, 0x22, 0xa, 0x20, 0x0,
		0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		0x0, 0xe2, 0x1, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55,
		0xa6, 0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0,
		0x1b, 0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21,
		0xea, 0x1, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6,
		0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b, 0x48, 0xe0, 0x1b,
		0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0xf0,
		0x1, 0x0, 0xf8, 0x1, 0x0, 0x82, 0x2, 0x0, 0x8a, 0x2, 0x0, 0x92, 0x2, 0x0,
		0x9a, 0x2, 0x0, 0xa2, 0x2, 0x0, 0xaa, 0x2, 0x0}
	expectedBlockProtoBytes = []byte{0xa, 0xc6, 0x1, 0xa, 0x22, 0xa, 0x20, 0xfb,
		0x31, 0x9c, 0x17, 0x22, 0xa, 0xa6, 0x31, 0x35, 0xa, 0x49, 0x8a, 0xa9, 0x49,
		0x5a, 0x10, 0xd9, 0x3, 0x93, 0x19, 0x6a, 0xfe, 0x7c, 0x8e, 0xe5, 0xea, 0x46,
		0x81, 0x4f, 0xd6, 0x20, 0x29, 0x12, 0x22, 0xa, 0x20, 0xfb, 0x31, 0x9c, 0x17,
		0x22, 0xa, 0xa6, 0x31, 0x35, 0xa, 0x49, 0x8a, 0xa9, 0x49, 0x5a, 0x10, 0xd9,
		...
		0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x1, 0x23, 0x45, 0x67, 0x89, 0xab,
		0xcd, 0xef, 0x1, 0x23, 0x45, 0x67, 0x89, 0x6a, 0x4, 0x0, 0x1, 0x2, 0x3,
		0x12, 0x96, 0x5, 0xa, 0x89, 0x5, 0xa, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f,
		0x17, 0x1b, 0xcc, 0x55, 0xa6, 0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8,
		0x6e, 0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5,
		0xe3, 0x63, 0xb4, 0x21, 0xa, 0x22, 0xa, 0x20, 0x56, 0xe8, 0x1f, 0x17, 0x1b,
		0xcc, 0x55, 0xa6, 0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e, 0x5b,
		...
		0x99, 0x6c, 0xad, 0xc0, 0x1, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, 0xf0,
		0x1, 0x0, 0xf8, 0x1, 0x0, 0x82, 0x2, 0x0, 0x8a, 0x2, 0x0, 0x92, 0x2, 0x0,
		0x9a, 0x2, 0x0, 0xa2, 0x2, 0x0, 0xaa, 0x2, 0x0, 0x12, 0x0, 0x1a, 0x0, 0x22,
		0x0, 0x2a, 0x0, 0x32, 0x0}
)
...
func TestWoSealHash(t *testing.T) {
	...
	expectedHash := common.HexToHash("0xca86754441199c5acced2f85cf03a8ec6292b3650ff4a05649053ada77eff325")
...
func TestCalcUncleHash(t *testing.T) {
	tests := []struct {
		...
		{
			uncleNum:          5,
			expectedUncleHash: common.HexToHash("0xb692630c40fc45a2b5d52731cd8e17d9fc32def5bcb4cc5a71d73f286f62a7cd"),
			expectedWoHash:    common.HexToHash("0x492522f1a8b4180cf5b82ba57b129f0874eaa64d319d22658a4b8567f01d1753"),
			shouldPass:        true,
		},
	}
