...
type Engine interface {
	...
	// CalcRegionDifficulty is the threshold adjustment algorithm for Region blocks per slice
	CalcRegionDifficulty(chain ChainHeaderReader, parent *types.Header) (*big.Int, error)

	// CalcPrimeDifficulty is the threshold adjustment algorithm for prime blocks per slice
	CalcPrimeDifficulty(chain ChainHeaderReader, parent *types.Header) (*big.Int, error)
