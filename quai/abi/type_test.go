...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"address[]", nil, common.BytesToAddress([]byte{1}, common.Location{0, 0}), ""},
		{"address[1]", nil, common.BytesToAddress([]byte{1}, common.Location{0, 0}), ""},
		{"address[1]", nil, common.BytesToAddress([]byte{1}, common.Location{0, 0}), ""},
		{"address[2]", nil, common.BytesToAddress([]byte{1}, common.Location{0, 0}), "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", nil, [32]byte{}, ""},
		{"bytes31", nil, [31]byte{}, ""},
		{"bytes30", nil, [30]byte{}, ""},
		{"bytes29", nil, [29]byte{}, ""},
