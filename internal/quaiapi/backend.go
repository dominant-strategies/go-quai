...
type Backend interface {
	...
	Append(header *types.Header, domPendingHeader *types.Header, domTerminus common.Hash, domS *big.Int, domOrigin bool, reorg bool, newInboundEtxs types.Transactions) ([]types.Transactions, *big.Int, *big.Int, bool, error)
	...
	SubRelayPendingHeader(pendingHeader types.PendingHeader, s *big.Int, location common.Location)
