...
func TestAccountRange(t *testing.T) {
	...
	var (
		...
		state, _ = state.New(common.Hash{}, common.Hash{}, big.NewInt(0), statedb, nil, nil, common.Location{0, 0}, log.Global)
...
func TestEmptyAccountRange(t *testing.T) {
	...
	var (
		...
		st, _   = state.New(common.Hash{}, common.Hash{}, big.NewInt(0), statedb, nil, nil, common.Location{0, 0}, log.Global)
	)
	st.Commit(true)
...
func TestStorageRangeAt(t *testing.T) {
	...
	var (
		state, _ = state.New(common.Hash{}, common.Hash{}, big.NewInt(0), state.NewDatabase(rawdb.NewMemoryDatabase(log.Global)), nil, nil, common.Location{0, 0}, log.Global)
