...
func (h *Header) EmptyEtxs() bool {
	return h.etxHash[common.PRIME_CTX] == EmptyRootHash &&
		h.etxHash[common.REGION_CTX] == EmptyRootHash &&
		h.etxHash[common.ZONE_CTX] == EmptyRootHash
}

// EmptyTxs returns true if there are no txs for this header/block.
func (h *Header) EmptyManifest() bool {
	return h.manifestHash[common.PRIME_CTX] == EmptyRootHash &&
		h.manifestHash[common.REGION_CTX] == EmptyRootHash &&
		h.manifestHash[common.ZONE_CTX] == EmptyRootHash
}
