...
func TestTxPool(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(sdb, nil, params.TestChainConfig, blake3pow.NewFullFaker(), vm.Config{}, nil, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, blake3pow.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, blake3pow.NewFullFaker(), nil)
	txPermanent = 50
