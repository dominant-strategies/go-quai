...
func (h Header) MarshalJSON() ([]byte, error) {
	var enc struct {
		...
		EntropyThreshold []*hexutil.Big `json:"entropyThreshold" 	gencodec:"required"`
	...
	enc.EntropyThreshold = make([]*hexutil.Big, common.HierarchyDepth)
	...
	for i := 0; i < common.HierarchyDepth; i++ {
		...
		enc.EntropyThreshold[i] = (*hexutil.Big)(h.EntropyThreshold(i))
...
func (h *Header) UnmarshalJSON(input []byte) error {
	...
	if dec.EntropyThreshold == nil {
		return errors.New("missing required field 'entropyThreshold' for Header")
	}
	...
	for i := 0; i < common.HierarchyDepth; i++ {
		...
		if dec.EntropyThreshold[i] == nil {
			return errors.New("missing required field 'entropyThreshold' for Header")
		}
		h.SetEntropyThreshold((*big.Int)(dec.EntropyThreshold[i]), i)
