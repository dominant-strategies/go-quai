...
type ProtoTxLookupEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ProtoTxLookupEntry) Reset() {
	*x = ProtoTxLookupEntry{}
	mi := &file_core_rawdb_db_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProtoTxLookupEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoTxLookupEntry) ProtoMessage() {}

func (x *ProtoTxLookupEntry) ProtoReflect() protoreflect.Message {
	mi := &file_core_rawdb_db_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtoTxLookupEntry.ProtoReflect.Descriptor instead.
func (*ProtoTxLookupEntry) Descriptor() ([]byte, []int) {
...
var file_core_rawdb_db_proto_rawDesc = string([]byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x64, 0x62, 0x22, 0x25, 0x0a, 0x0b, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x22, 0x35, 0x0a, 0x12, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x54, 0x78, 0x4c, 0x6f, 0x6f, 0x6b, 0x75,
	0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x69, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x72, 0x61, 0x77, 0x64, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})
...
var file_core_rawdb_db_proto_goTypes = []any{
	...
	(*ProtoTxLookupEntry)(nil), // 1: db.ProtoTxLookupEntry
}
