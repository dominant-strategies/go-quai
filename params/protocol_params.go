...
const (
	...
	ETXRLimitMin         uint64 = 50 * TxGas // Minimum possible cross-region ETX gas limit
	ETXPLimitMin         uint64 = 50 * TxGas // Minimum possible cross-prime ETX gas limit
	...
	ExpectedQiConversionGas              = 100000           // The approx. gas cost of a conversion
)
