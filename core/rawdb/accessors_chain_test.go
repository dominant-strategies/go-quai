...
func TestHeaderStorage(t *testing.T) {
	...
	header := &types.Header{Number: []*big.Int{big.NewInt(42), big.NewInt(42), big.NewInt(42)},
		Extra: [][]byte{[]byte("test header"), []byte("test header"), []byte("test header")}}
	if entry := ReadHeader(db, header.Hash(), header.Number[types.QuaiNetworkContext].Uint64()); entry != nil {
	...
	if entry := ReadHeaderRLP(db, header.Hash(), header.Number[types.QuaiNetworkContext].Uint64()); entry == nil {
	...
	DeleteHeader(db, header.Hash(), header.Number[types.QuaiNetworkContext].Uint64())
	if entry := ReadHeader(db, header.Hash(), header.Number[types.QuaiNetworkContext].Uint64()); entry != nil {
...
func TestBodyStorage(t *testing.T) {
	...
	body := &types.Body{Uncles: []*types.Header{{Extra: [][]byte{[]byte("test header"), []byte("test header"), []byte("test header")}}}}
...
func TestBlockStorage(t *testing.T) {
	...
	block := types.NewBlockWithHeader(&types.Header{
		Number:      []*big.Int{big.NewInt(int64(0)), big.NewInt(int64(0)), big.NewInt(int64(0))},
		Extra:       [][]byte{[]byte("test header"), []byte("test header"), []byte("test header")},
...
func TestBadBlockStorage(t *testing.T) {
	...
	block := types.NewBlockWithHeader(&types.Header{
		...
		Extra:       [][]byte{[]byte("bad block one"), []byte("bad block one"), []byte("bad block one")},
		UncleHash:   types.EmptyUncleHash,
		TxHash:      types.EmptyRootHash,
		ReceiptHash: types.EmptyRootHash,
	})
	...
	blockTwo := types.NewBlockWithHeader(&types.Header{
		Number:      []*big.Int{big.NewInt(2), big.NewInt(2), big.NewInt(2)},
		Extra:       [][]byte{[]byte("bad block two"), []byte("bad block two"), []byte("bad block two")},
		UncleHash:   types.EmptyUncleHash,
		TxHash:      types.EmptyRootHash,
		ReceiptHash: types.EmptyRootHash,
	})
	...
	for _, n := range rand.Perm(100) {
		block := types.NewBlockWithHeader(&types.Header{
			...
			Extra:       [][]byte{[]byte("bad block"), []byte("bad block"), []byte("bad block")},
			UncleHash:   types.EmptyUncleHash,
			TxHash:      types.EmptyRootHash,
			ReceiptHash: types.EmptyRootHash,
		})
...
func TestTdStorage(t *testing.T) {
	...
	hash, td := common.Hash{}, []*big.Int{big.NewInt(312), big.NewInt(312), big.NewInt(312)}
...
func TestHeadStorage(t *testing.T) {
	...
	blockHead := types.NewBlockWithHeader(&types.Header{Extra: [][]byte{[]byte("test block header"), []byte("test block header"), []byte("test block header")}})
	blockFull := types.NewBlockWithHeader(&types.Header{Extra: [][]byte{[]byte("test block full"), []byte("test block full"), []byte("test block full")}})
	blockFast := types.NewBlockWithHeader(&types.Header{Extra: [][]byte{[]byte("test block fast"), []byte("test block fast"), []byte("test block fast")}})
