...
func currentENREntry(core *core.Core) *enrEntry {
	return &enrEntry{
		ForkID: forkid.NewID(core.Config(), core.Genesis().Hash(), core.CurrentHeader().Number[types.QuaiNetworkContext].Uint64()),
	}
}
