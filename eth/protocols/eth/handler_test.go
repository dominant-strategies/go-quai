...
func newTestBackendWithGenerator(blocks int, generator func(int, *core.BlockGen)) *testBackend {
	...
	chain, _ := core.NewBlockChain(db, nil, params.TestChainConfig, blake3.NewFaker(), vm.Config{}, nil, nil)

	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), blake3.NewFaker(), db, blocks, generator)
...
func TestGetBlockHeaders66(t *testing.T) { testGetBlockHeaders(t, QUAI66) }
...
func TestGetBlockBodies66(t *testing.T) { testGetBlockBodies(t, QUAI66) }
...
func TestGetNodeData66(t *testing.T) { testGetNodeData(t, QUAI66) }
...
func TestGetBlockReceipts66(t *testing.T) { testGetBlockReceipts(t, QUAI66) }
