...
func file_p2p_node_peerManager_peerdb_peer_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_p2p_node_peerManager_peerdb_peer_info_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_p2p_node_peerManager_peerdb_peer_info_proto_msgTypes[1].Exporter = func(v any, i int) any {
