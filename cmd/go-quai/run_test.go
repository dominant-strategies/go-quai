...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "quai-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "quai-test" in runQuai.
	reexec.Register("quai-test", func() {
...
// spawns quai with the given command line args. If the args don't set --datadir, the
...
func runQuai(t *testing.T, args ...string) *testquai {
	...
	// Boot "quai". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("quai-test", args...)
