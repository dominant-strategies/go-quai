...
```shell
./build/bin/go-quai start --node.slices "[0 0]" --node.coinbases "0x00a3e45aa16163F2663015b6695894D918866d19" --node.environment "local" --rpc.http-api eth,quai,txpool --rpc.ws --rpc.ws-addr localhost --rpc.ws-api eth,quai,txpool --node.db-engine leveldb --node.consensus-engine blake3
```
