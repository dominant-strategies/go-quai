...
var (
	...
	ColosseumDurationLimit = []*big.Int{big.NewInt(150), big.NewInt(21), big.NewInt(3)}             // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
