...
CMD ./quai --$NETWORK --syncmode full --http --http.vhosts=* --ws --http.addr 0.0.0.0 --http.api eth,net,web3,quai,txpool --ws.addr 0.0.0.0 --ws.api eth,net,web3,quai,txpool --port $TCP_PORT --http.port $HTTP_PORT --ws.port $WS_PORT
