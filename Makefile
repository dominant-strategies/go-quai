...
ifeq (,$(wildcard nodelogs))
	...
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(PRIME_COINBASE) --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(PRIME_PORT_TCP) --http.port $(PRIME_PORT_HTTP) --ws.port $(PRIME_PORT_WS) --sub.urls $(PRIME_SUB_URLS) --quaistats ${STATS_NAME}:${STATS_PASS}@${PRIME_STATS_HOST} >> nodelogs/prime.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_1_PORT_TCP) --http.port $(REGION_1_PORT_HTTP) --ws.port $(REGION_1_PORT_WS) --dom.url $(REGION_1_DOM_URL):$(PRIME_PORT_WS) --sub.urls $(REGION_1_SUB_URLS) --region 1 --quaistats ${STATS_NAME}:${STATS_PASS}@${REGION_1_STATS_HOST} >> nodelogs/region-1.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_2_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_2_PORT_TCP) --http.port $(REGION_2_PORT_HTTP) --ws.port $(REGION_2_PORT_WS) --dom.url $(REGION_2_DOM_URL):$(PRIME_PORT_WS) --sub.urls $(REGION_2_SUB_URLS) --region 2 --quaistats ${STATS_NAME}:${STATS_PASS}@${REGION_2_STATS_HOST} >> nodelogs/region-2.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(REGION_3_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(REGION_3_PORT_TCP) --http.port $(REGION_3_PORT_HTTP) --ws.port $(REGION_3_PORT_WS) --dom.url $(REGION_3_DOM_URL):$(PRIME_PORT_WS) --sub.urls $(REGION_3_SUB_URLS) --region 3 --quaistats ${STATS_NAME}:${STATS_PASS}@${REGION_3_STATS_HOST} >> nodelogs/region-3.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_1_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_1_1_PORT_TCP) --http.port $(ZONE_1_1_PORT_HTTP) --ws.port $(ZONE_1_1_PORT_WS) --dom.url $(ZONE_1_1_DOM_URL):$(REGION_1_PORT_WS) --region 1 --zone 1 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_1_1_STATS_HOST} >> nodelogs/zone-1-1.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_1_2_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_1_2_PORT_TCP) --http.port $(ZONE_1_2_PORT_HTTP) --ws.port $(ZONE_1_2_PORT_WS) --dom.url $(ZONE_1_2_DOM_URL):$(REGION_1_PORT_WS) --region 1 --zone 2 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_1_2_STATS_HOST} >> nodelogs/zone-1-2.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_1_3_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_1_3_PORT_TCP) --http.port $(ZONE_1_3_PORT_HTTP) --ws.port $(ZONE_1_3_PORT_WS) --dom.url $(ZONE_1_3_DOM_URL):$(REGION_1_PORT_WS) --region 1 --zone 3 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_1_3_STATS_HOST} >> nodelogs/zone-1-3.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_2_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_2_1_PORT_TCP) --http.port $(ZONE_2_1_PORT_HTTP) --ws.port $(ZONE_2_1_PORT_WS) --dom.url $(ZONE_2_1_DOM_URL):$(REGION_2_PORT_WS) --region 2 --zone 1 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_2_1_STATS_HOST} >> nodelogs/zone-2-1.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_2_2_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_2_2_PORT_TCP) --http.port $(ZONE_2_2_PORT_HTTP) --ws.port $(ZONE_2_2_PORT_WS) --dom.url $(ZONE_2_2_DOM_URL):$(REGION_2_PORT_WS) --region 2 --zone 2 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_2_2_STATS_HOST} >> nodelogs/zone-2-2.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_2_3_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_2_3_PORT_TCP) --http.port $(ZONE_2_3_PORT_HTTP) --ws.port $(ZONE_2_3_PORT_WS) --dom.url $(ZONE_2_3_DOM_URL):$(REGION_2_PORT_WS) --region 2 --zone 3 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_2_3_STATS_HOST} >> nodelogs/zone-2-3.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_3_1_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_3_1_PORT_TCP) --http.port $(ZONE_3_1_PORT_HTTP) --ws.port $(ZONE_3_1_PORT_WS) --dom.url $(ZONE_3_1_DOM_URL):$(REGION_3_PORT_WS) --region 3 --zone 1 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_3_1_STATS_HOST} >> nodelogs/zone-3-1.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_3_2_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_3_2_PORT_TCP) --http.port $(ZONE_3_2_PORT_HTTP) --ws.port $(ZONE_3_2_PORT_WS) --dom.url $(ZONE_3_2_DOM_URL):$(REGION_3_PORT_WS) --region 3 --zone 2 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_3_2_STATS_HOST} >> nodelogs/zone-3-2.log 2>&1 &
	@nohup $(MINING_BASE_COMMAND) --miner.etherbase $(ZONE_3_3_COINBASE)  --http.addr $(HTTP_ADDR) --http.api $(HTTP_API) --ws.addr $(WS_ADDR) --ws.api $(WS_API)  --port $(ZONE_3_3_PORT_TCP) --http.port $(ZONE_3_3_PORT_HTTP) --ws.port $(ZONE_3_3_PORT_WS) --dom.url $(ZONE_3_2_DOM_URL):$(REGION_3_PORT_WS) --region 3 --zone 3 --quaistats ${STATS_NAME}:${STATS_PASS}@${ZONE_3_3_STATS_HOST} >> nodelogs/zone-3-3.log 2>&1 &
