...
# 1. install quai for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for quai
# 5. create quai, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable QUAI_SOCKET
...
!define GROUPNAME "Quai"
!define APPNAME "quai"
!define DESCRIPTION "Official Go implementation of the Quai protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since quai is installed global
