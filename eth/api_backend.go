...
func (b *EthAPIBackend) UpdatePendingHeader(header *types.Header, pendingHeader *types.Header, slCurrentHeader *types.Header) error {
	return b.eth.core.UpdatePendingHeader(header, pendingHeader, slCurrentHeader)
}
