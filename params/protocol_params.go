...
const (
	...
	ETXRegionMaxFraction  int    = common.Width * (common.Width - 1) // The maximum fraction of transactions for cross-region ETXs
	ETXPrimeMaxFraction   int    = common.Width * common.Width       // The maximum fraction of transactions for cross-prime ETXs
...
var (
	...
	PrimeEntropyTarget                = big.NewInt(TimeFactor.Int64() * TimeFactor.Int64() * common.Width * common.Width) // This is TimeFactor*TimeFactor*common.Width*common.Width
	RegionEntropyTarget               = big.NewInt(TimeFactor.Int64() * common.Width)                                     // This is TimeFactor*common.Width
