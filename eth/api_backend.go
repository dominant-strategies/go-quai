...
func (b *QuaiAPIBackend) Append(header *types.Header, domPendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool, manifestHash common.Hash, newInboundEtxs types.Transactions) ([]types.Transactions, error) {
	return b.eth.core.Append(header, domPendingHeader, domTerminus, td, domOrigin, reorg, manifestHash, newInboundEtxs)
}
