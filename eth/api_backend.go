...
func (b *QuaiAPIBackend) Append(header *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool, newInboundEtxs types.Transactions) (types.PendingHeader, []types.Transactions, error) {
	return b.eth.core.Append(header, domTerminus, td, domOrigin, reorg, newInboundEtxs)
}
...
func (b *QuaiAPIBackend) PendingBlockBody(sealHash common.Hash) *types.Body {
	return b.eth.core.PendingBlockBody(sealHash)
}
